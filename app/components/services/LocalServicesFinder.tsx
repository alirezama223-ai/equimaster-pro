...
const text: Record<string, Record<string, string>> = {
  en: { title: "Find Equestrian Services Near You", sub: "Riding lessons, trainers, horse training and more — search by location and distance.", search: "Search name, city or discipline", all: "All services", radius: "Radius", locate: "Use my location", active: "Location active", no: "No matching services found yet.", verified: "Verified", maps: "Open in Maps", view: "View profile", add: "Are you a service provider? Add your service through the Services page.", loading: "Loading services…", loadError: "We couldn't load services right now. Please refresh and try again." },
  de: { title: "Reitsportangebote in Ihrer Nähe", sub: "Reitunterricht, Trainer, Pferdetraining und mehr — suchen Sie nach Ort und Entfernung.", search: "Name, Stadt oder Disziplin", all: "Alle Angebote", radius: "Umkreis", locate: "Meinen Standort verwenden", active: "Standort aktiv", no: "Noch keine passenden Angebote gefunden.", verified: "Verifiziert", maps: "In Maps öffnen", view: "Profil ansehen", add: "Sie bieten eine Dienstleistung an? Fügen Sie Ihr Angebot über die Services-Seite hinzu.", loading: "Angebote werden geladen…", loadError: "Angebote konnten gerade nicht geladen werden. Bitte aktualisieren Sie die Seite." },
  fr: { title: "Services équestres près de chez vous", sub: "Cours d'équitation, entraîneurs, entraînement et plus — recherchez par lieu et distance.", search: "Nom, ville ou discipline", all: "Tous les services", radius: "Rayon", locate: "Utiliser ma position", active: "Position active", no: "Aucun service correspondant pour le moment.", verified: "Vérifié", maps: "Ouvrir dans Maps", view: "Voir le profil", add: "Vous êtes prestataire ? Ajoutez votre service depuis la page Services.", loading: "Chargement des services…", loadError: "Impossible de charger les services pour le moment. Actualisez la page et réessayez." },
  es: { title: "Servicios ecuestres cerca de ti", sub: "Clases de equitación, entrenadores, entrenamiento y más — busca por ubicación y distancia.", search: "Nombre, ciudad o disciplina", all: "Todos los servicios", radius: "Radio", locate: "Usar mi ubicación", active: "Ubicación activa", no: "Aún no hay servicios coincidentes.", verified: "Verificado", maps: "Abrir en Maps", view: "Ver perfil", add: "¿Eres proveedor? Añade tu servicio desde la página de Servicios.", loading: "Cargando servicios…", loadError: "No se han podido cargar los servicios. Actualiza la página e inténtalo de nuevo." },
  nl: { title: "Paardensportdiensten bij jou in de buurt", sub: "Lessen, trainers, paardentraining en meer — zoek op locatie en afstand.", search: "Naam, stad of discipline", all: "Alle diensten", radius: "Straal", locate: "Mijn locatie gebruiken", active: "Locatie actief", no: "Nog geen passende diensten gevonden.", verified: "Geverifieerd", maps: "Openen in Maps", view: "Profiel bekijken", add: "Ben je aanbieder? Voeg je dienst toe via de Services-pagina.", loading: "Diensten worden geladen…", loadError: "De diensten konden niet worden geladen. Vernieuw de pagina en probeer het opnieuw." },
};
