...
const text: Record<string, Record<string, string>> = {
  en: { title: "Find Equestrian Services Near You", sub: "Riding lessons, trainers, horse training and more — search by location and distance.", search: "Search name, city or discipline", all: "All services", radius: "Radius", locate: "Use my location", active: "Location active", no: "No matching services found yet.", verified: "Verified", maps: "Open in Maps", add: "Are you a service provider? Add your service through the Services page." },
...
export default function LocalServicesFinder({ locale, providers }: Props) {
