...
export type PedigreeHorseCardLabels = {
  registrationLine?: string;
};

type Props = {
  result: PedigreeSearchResult;
  labels: PedigreeHorseCardLabels;
};

export default function PedigreeHorseCardView({ result, labels }: Props) {
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="mt-2 text-xs text-gray-500">
          ...
          {labels.registrationLine ? ` · ${labels.registrationLine}` : ""}
        </p>
      </div>
    </Link>
  );
