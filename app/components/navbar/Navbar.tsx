  ...
  return (
    <header className="glass-surface fixed top-0 left-0 z-50 isolate w-full border-b border-white/10">
      <div className="mx-auto flex h-16 min-w-0 max-w-7xl items-center justify-between gap-2 px-3 md:hidden">
        <Link
          href="/"
          aria-label="SHABDIZ Sport Horses Marketplace"
          className="inline-flex min-h-11 min-w-0 shrink-0 items-center transition-opacity hover:opacity-90"
        >
          <Image
            src={BRAND_LOGO_SRC}
            alt="SHABDIZ Sport Horses Marketplace"
            width={178}
            height={50}
            priority
      ...
      <div className="mx-auto hidden h-16 min-w-0 max-w-7xl items-center gap-2 px-3 sm:h-20 sm:gap-4 sm:px-6 md:flex lg:px-8">
        ...
        >
          <Image
            ...
            height={62}
            priority
            className="h-auto w-[170px] object-contain sm:w-[190px] 2xl:w-[220px]"
          />
        </Link>
