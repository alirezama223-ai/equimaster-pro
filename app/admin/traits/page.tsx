      ...
      <main className="min-h-screen bg-[#08111F] pt-28 pb-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-8">
            ...
            <h1 className="mt-2 text-4xl font-black text-white">Trait Evidence Review</h1>
            <p className="mt-3 text-gray-400">
              Review structured trait evidence, verify appropriate records, and preserve provenance.
            </p>
          </div>
          <AdminTraitsClient
            filter={filter}
