...
export default async function StallionDetailPage({ params }: Props) {
  ...
  const traitResult = pedigreeHorseId ? await getHorseTraitProfile(pedigreeHorseId) : null;
      ...
      <main className="bg-[#081223] min-h-screen text-white pt-28 pb-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <EntityGallery images={stallion.images} altPrefix={stallion.name} />
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl font-black">{stallion.name}</h1>
              ...
              <div className="mt-8 rounded-2xl border border-white/10 bg-[#111827] p-6">
                ...
                <p className="mt-1 text-gray-400">
                  📍 {stallion.breeder.city ? `${stallion.breeder.city}, ` : ""}
