...
export default async function PedigreeTimelinePage({ params }: Props) {
  ...
  if (!user) {
    redirect(loginRedirectPath(`/pedigree/${id}/timeline`));
  }
    ...
    <>
      ...
      <main className="min-h-screen bg-[#081223] text-white pt-28 pb-24">
        <div className="max-w-4xl mx-auto px-6 space-y-6">
          ...
          <Suspense fallback={<div className="py-12 text-sm text-gray-400">Loading timeline...</div>}>
            <HorseTimelineClient
              initialHorseId={id}
