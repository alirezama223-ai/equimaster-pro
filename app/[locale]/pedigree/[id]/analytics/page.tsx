...
export default async function PedigreeAnalyticsPage({ params }: Props) {
  ...
  if (!user) {
    redirect(loginRedirectPath(`/pedigree/${id}/analytics`));
  }
    ...
    <>
      ...
      <main className="min-h-screen bg-[#081223] text-white pt-28 pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-6">
          ...
          <Suspense fallback={<div className="py-12 text-sm text-gray-400">Loading analytics...</div>}>
