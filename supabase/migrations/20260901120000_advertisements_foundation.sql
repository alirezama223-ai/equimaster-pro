-- Advertisement foundation for scheduled, moderated placements.
...
create table if not exists public.advertisements (
  ...
  constraint advertisements_target_url check (target_url ~* '^https?://')
);
...
-- Public users may only read currently active, scheduled advertisements.
...
-- No direct public insert/update/delete policy is created.
-- Administrative writes will be handled through a protected server-side action.
